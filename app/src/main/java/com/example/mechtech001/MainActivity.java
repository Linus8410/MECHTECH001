...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
                ...
                PhoneAuthOptions options = PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationCompleted(@NonNull PhoneAuthCredential credential) {
                                ...
                                verifyPinAndSignIn(credential, pin);
                            }
            ...
            // Method to check the entered PIN and sign in if correct
            private void verifyPinAndSignIn(PhoneAuthCredential credential, String enteredPin) {
                String expectedPin = "1234"; // Replace with actual PIN check
